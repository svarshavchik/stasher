...
testpeerstatusannouncerObj::~testpeerstatusannouncerObj()
{
}
...

{
	...
	tracker->start_threadmsgdispatcher(testthread, socket, inputiter, tracker, mcguffin);
